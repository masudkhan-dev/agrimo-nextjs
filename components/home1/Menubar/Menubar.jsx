          ...
          >
            {item.dropdown.map((dropItem, dropIndex) => (
              <li key={dropIndex}>
                <Link
                  href={dropItem.href}
                  className={`block px-4 py-2 text-sm text-[#19653b] agrimo hover:text-[#fff] hover:bg-[#19653b] hover:border-l-8 hover:border-[#efdc69] cursor-pointer transition-all duration-700 ${
                    isActive(dropItem.href)
                      ? "bg-[#19653d] text-[#fff] font-bold italic border-l-8 border-[#efdc69]"
                      : ""
                  }`}
                >
                  {dropItem.name}
  ...
  const renderMobileNavItem = (item, index) => {
    ...
    return (
      <li key={index} className="block">
          ...
          {item.href ? (
            <Link
              ...
              className={`flex items-center ${
                active ? "bg-[#19653b] text-white z-50" : "text-[#fff] z-50"
            ...
            <span
              className={`flex items-center z-50 ${
                active ? "bg-[#fff] text-[19653b]" : "bg-[#19653b] text-[#fff]"
              } cursor-pointer px-3 py-2 rounded-md text-base font-medium`}
        ...
        {item.dropdown && (
          <ul
            className={`pl-4 mt-2 space-y-2 bg-[#fff] rounded-lg text-[#19653b] border-t-8 border-[#efdc69] transition-all duration-700 transform z-50 ${
              activeDropdown === index
          ...
          >
            {item.dropdown.map((dropItem, dropIndex) => (
              <li key={dropIndex}>
                <Link
                  href={dropItem.href}
                  className={`block px-3 py-3 text-sm z-50 ${
                    isActive(dropItem.href)
                      ? "text-[#fff] bg-[#19653b] font-bold italic border-l-8 border-[#efdc69]"
                      : "text-[#19653b]  hover:text-[#fff] hover:bg-[#19653b]"
